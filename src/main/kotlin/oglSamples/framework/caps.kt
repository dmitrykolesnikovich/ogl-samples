...
//
//        @JvmField
//        val MINOR_VERSION = GL11.glGetInteger(GL30.GL_MINOR_VERSION)
//        @JvmField
//        val MAJOR_VERSION = GL11.glGetInteger(GL30.GL_MAJOR_VERSION)
//        //         val CONTEXT_FLAGS =
////                if (check(4, 3) || glisExtensionAvailable("GL_KHR_debug"))
////                    glGetInteger(GL_CONTEXT_FLAGS)
////                else 0
//        @JvmField
//        val NUM_EXTENSIONS = GL11.glGetInteger(GL30.GL_NUM_EXTENSIONS)
//        @JvmField
...
//        @JvmField
//        val SHADING_LANGUAGE_VERSION = GL11.glGetString(GL20.GL_SHADING_LANGUAGE_VERSION)
//        @JvmField
...
//
//
//        private val glslVersions by lazy { (0 until NUM_SHADING_LANGUAGE_VERSIONS).map { GL30.glGetStringi(GL20.GL_SHADING_LANGUAGE_VERSION, it) } }
//
//        @JvmField
//        val glsl100 = has("100")
//        @JvmField
...
//
//        val list by lazy { (0 until version.NUM_EXTENSIONS).map { GL30.glGetStringi(GL11.GL_EXTENSIONS, it) } }
//
//        @JvmField
...
//    inner class Debug {
//        @JvmField
//        val CONTEXT_FLAGS = GL11.glGetInteger(GL30.GL_CONTEXT_FLAGS)
//        @JvmField
//        val MAX_DEBUG_GROUP_STACK_DEPTH = GL11.glGetInteger(GL43.GL_MAX_DEBUG_GROUP_STACK_DEPTH)
//        @JvmField
//        val MAX_LABEL_LENGTH = GL11.glGetInteger(GL43.GL_MAX_LABEL_LENGTH)
//        @JvmField
//        val MAX_SERVER_WAIT_TIMEOUT = GL11.glGetInteger(GL32.GL_MAX_SERVER_WAIT_TIMEOUT)
//
//        fun write(w: PrintWriter) = this::class.memberProperties.filter { it.visibility == KVisibility.PUBLIC }.map {
//            w.println("${it.name} = ${it.getter.call(this)}")
//        }
...
//        @JvmField
//        val NUM_COMPRESSED_TEXTURE_FORMATS = GL11.glGetInteger(GL13.GL_NUM_COMPRESSED_TEXTURE_FORMATS)
//        @JvmField
...
//                MAX_COMPUTE_TEXTURE_IMAGE_UNITS = GL11.glGetInteger(GL43.GL_MAX_COMPUTE_TEXTURE_IMAGE_UNITS)
//                MAX_COMPUTE_UNIFORM_COMPONENTS = GL11.glGetInteger(GL43.GL_MAX_COMPUTE_UNIFORM_COMPONENTS)
//                MAX_COMPUTE_SHARED_MEMORY_SIZE = GL11.glGetInteger(GL43.GL_MAX_COMPUTE_SHARED_MEMORY_SIZE)
//                MAX_COMPUTE_WORK_GROUP_INVOCATIONS = GL11.glGetInteger(GL43.GL_MAX_COMPUTE_WORK_GROUP_INVOCATIONS)
//                MAX_COMPUTE_WORK_GROUP_COUNT = GL30.glGetIntegeri(GL43.GL_MAX_COMPUTE_WORK_GROUP_COUNT, 0)
//                MAX_COMPUTE_WORK_GROUP_SIZE = GL30.glGetIntegeri(GL43.GL_MAX_COMPUTE_WORK_GROUP_SIZE, 0)
//            }
//
//            if (check(4, 3) || (extensions.ARB_compute_shader && extensions.ARB_uniform_buffer_object)) {
//                MAX_COMPUTE_UNIFORM_BLOCKS = GL11.glGetInteger(GL43.GL_MAX_COMPUTE_UNIFORM_BLOCKS)
//                MAX_COMBINED_COMPUTE_UNIFORM_COMPONENTS = GL11.glGetInteger(GL43.GL_MAX_COMBINED_COMPUTE_UNIFORM_COMPONENTS)
//            }
//
//            if (check(4, 3) || (extensions.ARB_compute_shader && extensions.ARB_shader_image_load_store))
//                MAX_COMPUTE_IMAGE_UNIFORMS = GL11.glGetInteger(GL43.GL_MAX_COMPUTE_IMAGE_UNIFORMS)
//
//            if (check(4, 3) || (extensions.ARB_compute_shader && extensions.ARB_shader_atomic_counters)) {
//                MAX_COMPUTE_ATOMIC_COUNTERS = GL11.glGetInteger(GL43.GL_MAX_COMPUTE_ATOMIC_COUNTERS)
//                MAX_COMPUTE_ATOMIC_COUNTER_BUFFERS = GL11.glGetInteger(GL43.GL_MAX_COMPUTE_ATOMIC_COUNTER_BUFFERS)
//            }
//
//            if (check(4, 3) || (extensions.ARB_compute_shader && extensions.ARB_shader_storage_buffer_object))
//                MAX_COMPUTE_SHADER_STORAGE_BLOCKS = GL11.glGetInteger(GL43.GL_MAX_COMPUTE_SHADER_STORAGE_BLOCKS)
//
//
//            if (check(2, 1) || extensions.ARB_vertex_shader) {
//                MAX_VERTEX_ATTRIBS = GL11.glGetInteger(GL20.GL_MAX_VERTEX_ATTRIBS)
//                MAX_VERTEX_OUTPUT_COMPONENTS = GL11.glGetInteger(GL32.GL_MAX_VERTEX_OUTPUT_COMPONENTS)
//                MAX_VERTEX_TEXTURE_IMAGE_UNITS = GL11.glGetInteger(GL20.GL_MAX_VERTEX_TEXTURE_IMAGE_UNITS)
//                MAX_VERTEX_UNIFORM_COMPONENTS = GL11.glGetInteger(GL20.GL_MAX_VERTEX_UNIFORM_COMPONENTS)
//                MAX_VERTEX_UNIFORM_VECTORS = GL11.glGetInteger(GL41.GL_MAX_VERTEX_UNIFORM_VECTORS)
//            }
//            if (check(3, 2) || (extensions.ARB_vertex_shader && extensions.ARB_uniform_buffer_object)) {
//                MAX_VERTEX_UNIFORM_BLOCKS = GL11.glGetInteger(GL31.GL_MAX_VERTEX_UNIFORM_BLOCKS)
//                MAX_COMBINED_VERTEX_UNIFORM_COMPONENTS = GL11.glGetInteger(GL31.GL_MAX_COMBINED_VERTEX_UNIFORM_COMPONENTS)
//            }
//            if (check(4, 2) || (extensions.ARB_vertex_shader && extensions.ARB_shader_atomic_counters))
//                MAX_VERTEX_ATOMIC_COUNTERS = GL11.glGetInteger(GL42.GL_MAX_VERTEX_ATOMIC_COUNTERS)
//            if (check(4, 3) || (extensions.ARB_vertex_shader && extensions.ARB_shader_storage_buffer_object))
//                MAX_VERTEX_SHADER_STORAGE_BLOCKS = GL11.glGetInteger(GL43.GL_MAX_VERTEX_SHADER_STORAGE_BLOCKS)
//
//            if (check(4, 0) || extensions.ARB_tessellation_shader) {
//                MAX_TESS_CONTROL_INPUT_COMPONENTS = GL11.glGetInteger(GL40.GL_MAX_TESS_CONTROL_INPUT_COMPONENTS)
//                MAX_TESS_CONTROL_OUTPUT_COMPONENTS = GL11.glGetInteger(GL40.GL_MAX_TESS_CONTROL_OUTPUT_COMPONENTS)
//                MAX_TESS_CONTROL_TEXTURE_IMAGE_UNITS = GL11.glGetInteger(GL40.GL_MAX_TESS_CONTROL_TEXTURE_IMAGE_UNITS)
//                MAX_TESS_CONTROL_UNIFORM_COMPONENTS = GL11.glGetInteger(GL40.GL_MAX_TESS_CONTROL_UNIFORM_COMPONENTS)
//            }
//            if (check(4, 0) || (extensions.ARB_tessellation_shader && extensions.ARB_uniform_buffer_object)) {
//                MAX_TESS_CONTROL_UNIFORM_BLOCKS = GL11.glGetInteger(GL40.GL_MAX_TESS_CONTROL_UNIFORM_BLOCKS)
//                MAX_COMBINED_TESS_CONTROL_UNIFORM_COMPONENTS = GL11.glGetInteger(GL40.GL_MAX_COMBINED_TESS_CONTROL_UNIFORM_COMPONENTS)
//            }
//            if (check(4, 2) || (extensions.ARB_tessellation_shader && extensions.ARB_shader_atomic_counters))
//                MAX_TESS_CONTROL_ATOMIC_COUNTERS = GL11.glGetInteger(GL42.GL_MAX_TESS_CONTROL_ATOMIC_COUNTERS)
//            if (check(4, 3) || (extensions.ARB_tessellation_shader && extensions.ARB_shader_storage_buffer_object))
//                MAX_TESS_CONTROL_SHADER_STORAGE_BLOCKS = GL11.glGetInteger(GL43.GL_MAX_TESS_CONTROL_SHADER_STORAGE_BLOCKS)
//
//            if (check(4, 0) || extensions.ARB_tessellation_shader) {
//                MAX_TESS_EVALUATION_INPUT_COMPONENTS = GL11.glGetInteger(GL40.GL_MAX_TESS_EVALUATION_INPUT_COMPONENTS)
//                MAX_TESS_EVALUATION_OUTPUT_COMPONENTS = GL11.glGetInteger(GL40.GL_MAX_TESS_EVALUATION_OUTPUT_COMPONENTS)
//                MAX_TESS_EVALUATION_TEXTURE_IMAGE_UNITS = GL11.glGetInteger(GL40.GL_MAX_TESS_EVALUATION_TEXTURE_IMAGE_UNITS)
//                MAX_TESS_EVALUATION_UNIFORM_COMPONENTS = GL11.glGetInteger(GL40.GL_MAX_TESS_EVALUATION_UNIFORM_COMPONENTS)
//            }
//            if (check(4, 0) || (extensions.ARB_tessellation_shader && extensions.ARB_uniform_buffer_object)) {
//                MAX_TESS_EVALUATION_UNIFORM_BLOCKS = GL11.glGetInteger(GL40.GL_MAX_TESS_EVALUATION_UNIFORM_BLOCKS)
//                MAX_COMBINED_TESS_EVALUATION_UNIFORM_COMPONENTS = GL11.glGetInteger(GL40.GL_MAX_COMBINED_TESS_EVALUATION_UNIFORM_COMPONENTS)
//            }
//            if (check(4, 2) || (extensions.ARB_tessellation_shader && extensions.ARB_shader_atomic_counters))
//                MAX_TESS_EVALUATION_ATOMIC_COUNTERS = GL11.glGetInteger(GL42.GL_MAX_TESS_EVALUATION_ATOMIC_COUNTERS)
//            if (check(4, 3) || (extensions.ARB_tessellation_shader && extensions.ARB_shader_storage_buffer_object))
//                MAX_TESS_EVALUATION_SHADER_STORAGE_BLOCKS = GL11.glGetInteger(GL43.GL_MAX_TESS_EVALUATION_SHADER_STORAGE_BLOCKS)
//
//            if (check(3, 2) || extensions.ARB_geometry_shader4) {
//                MAX_GEOMETRY_INPUT_COMPONENTS = GL11.glGetInteger(GL32.GL_MAX_GEOMETRY_INPUT_COMPONENTS)
//                MAX_GEOMETRY_OUTPUT_COMPONENTS = GL11.glGetInteger(GL32.GL_MAX_GEOMETRY_OUTPUT_COMPONENTS)
//                MAX_GEOMETRY_TEXTURE_IMAGE_UNITS = GL11.glGetInteger(GL32.GL_MAX_GEOMETRY_TEXTURE_IMAGE_UNITS)
//                MAX_GEOMETRY_UNIFORM_COMPONENTS = GL11.glGetInteger(GL32.GL_MAX_GEOMETRY_UNIFORM_COMPONENTS)
//            }
//            if (check(3, 2) || (extensions.ARB_geometry_shader4 && extensions.ARB_uniform_buffer_object)) {
//                MAX_GEOMETRY_UNIFORM_BLOCKS = GL11.glGetInteger(GL31.GL_MAX_GEOMETRY_UNIFORM_BLOCKS)
//                MAX_COMBINED_GEOMETRY_UNIFORM_COMPONENTS = GL11.glGetInteger(GL31.GL_MAX_COMBINED_GEOMETRY_UNIFORM_COMPONENTS)
//            }
//            if (check(4, 0) || (extensions.ARB_geometry_shader4 && extensions.ARB_transform_feedback3))
//                MAX_VERTEX_STREAMS = GL11.glGetInteger(GL40.GL_MAX_VERTEX_STREAMS)
//            if (check(4, 2) || (extensions.ARB_geometry_shader4 && extensions.ARB_shader_atomic_counters))
//                MAX_GEOMETRY_ATOMIC_COUNTERS = GL11.glGetInteger(GL42.GL_MAX_GEOMETRY_ATOMIC_COUNTERS)
//            if (check(4, 3) || (extensions.ARB_geometry_shader4 && extensions.ARB_shader_storage_buffer_object))
//                MAX_GEOMETRY_SHADER_STORAGE_BLOCKS = GL11.glGetInteger(GL43.GL_MAX_GEOMETRY_SHADER_STORAGE_BLOCKS)
//
//            if (check(2, 1))
//                MAX_DRAW_BUFFERS = GL11.glGetInteger(GL20.GL_MAX_DRAW_BUFFERS)
//
//            if (check(2, 1) || extensions.ARB_fragment_shader) {
//                MAX_FRAGMENT_INPUT_COMPONENTS = GL11.glGetInteger(GL32.GL_MAX_FRAGMENT_INPUT_COMPONENTS)
//                MAX_FRAGMENT_UNIFORM_COMPONENTS = GL11.glGetInteger(GL20.GL_MAX_FRAGMENT_UNIFORM_COMPONENTS)
//                MAX_FRAGMENT_UNIFORM_VECTORS = GL11.glGetInteger(GL41.GL_MAX_FRAGMENT_UNIFORM_VECTORS)
//            }
//            if (check(3, 2) || (extensions.ARB_fragment_shader && extensions.ARB_uniform_buffer_object)) {
//                MAX_FRAGMENT_UNIFORM_BLOCKS = GL11.glGetInteger(GL31.GL_MAX_FRAGMENT_UNIFORM_BLOCKS)
//                MAX_COMBINED_FRAGMENT_UNIFORM_COMPONENTS = GL11.glGetInteger(GL31.GL_MAX_COMBINED_FRAGMENT_UNIFORM_COMPONENTS)
//            }
//            if (check(3, 3) || extensions.ARB_blend_func_extended)
//                MAX_DUAL_SOURCE_DRAW_BUFFERS = GL11.glGetInteger(GL33.GL_MAX_DUAL_SOURCE_DRAW_BUFFERS)
//            if (check(4, 2) || (extensions.ARB_fragment_shader && extensions.ARB_shader_atomic_counters))
//                MAX_FRAGMENT_ATOMIC_COUNTERS = GL11.glGetInteger(GL42.GL_MAX_FRAGMENT_ATOMIC_COUNTERS)
//            if (check(4, 3) || (extensions.ARB_fragment_shader && extensions.ARB_shader_storage_buffer_object))
//                MAX_FRAGMENT_SHADER_STORAGE_BLOCKS = GL11.glGetInteger(GL43.GL_MAX_FRAGMENT_SHADER_STORAGE_BLOCKS)
//
...
//                MAX_FRAMEBUFFER_LAYERS = GL11.glGetInteger(GL43.GL_MAX_FRAMEBUFFER_LAYERS)
//                MAX_FRAMEBUFFER_SAMPLES = GL11.glGetInteger(GL43.GL_MAX_FRAMEBUFFER_SAMPLES)
//            }
//
//            if (check(4, 0) || extensions.ARB_transform_feedback3)
//                MAX_TRANSFORM_FEEDBACK_BUFFERS = GL11.glGetInteger(GL40.GL_MAX_TRANSFORM_FEEDBACK_BUFFERS)
//            if (check(4, 2) || extensions.ARB_map_buffer_alignment)
//                MIN_MAP_BUFFER_ALIGNMENT = GL11.glGetInteger(GL42.GL_MIN_MAP_BUFFER_ALIGNMENT)
//
//            if (extensions.NV_deep_texture3D) {
//                MAX_DEEP_3D_TEXTURE_WIDTH_HEIGHT_NV = GL11.glGetInteger(NVDeepTexture3D.GL_MAX_DEEP_3D_TEXTURE_WIDTH_HEIGHT_NV)
//                MAX_DEEP_3D_TEXTURE_DEPTH_NV = GL11.glGetInteger(NVDeepTexture3D.GL_MAX_DEEP_3D_TEXTURE_DEPTH_NV)
//            }
//
//            if (check(2, 1)) {
//                MAX_TEXTURE_IMAGE_UNITS = GL11.glGetInteger(GL20.GL_MAX_TEXTURE_IMAGE_UNITS)
//                MAX_COMBINED_TEXTURE_IMAGE_UNITS = GL11.glGetInteger(GL20.GL_MAX_COMBINED_TEXTURE_IMAGE_UNITS)
//                MAX_TEXTURE_MAX_ANISOTROPY_EXT = GL11.glGetInteger(EXTTextureFilterAnisotropic.GL_MAX_TEXTURE_MAX_ANISOTROPY_EXT)
//            }
//
//            if (check(3, 0) || extensions.ARB_texture_buffer_object)
//                MAX_TEXTURE_BUFFER_SIZE = GL11.glGetInteger(GL31.GL_MAX_TEXTURE_BUFFER_SIZE)
//
//            if (check(3, 2) || extensions.ARB_texture_multisample) {
//                MAX_SAMPLE_MASK_WORDS = GL11.glGetInteger(GL32.GL_MAX_SAMPLE_MASK_WORDS)
//                MAX_COLOR_TEXTURE_SAMPLES = GL11.glGetInteger(GL32.GL_MAX_COLOR_TEXTURE_SAMPLES)
//                MAX_DEPTH_TEXTURE_SAMPLES = GL11.glGetInteger(GL32.GL_MAX_DEPTH_TEXTURE_SAMPLES)
//                MAX_INTEGER_SAMPLES = GL11.glGetInteger(GL32.GL_MAX_INTEGER_SAMPLES)
//            }
//
//            if (check(3, 3) || extensions.ARB_texture_rectangle)
//                MAX_RECTANGLE_TEXTURE_SIZE = GL11.glGetInteger(GL31.GL_MAX_RECTANGLE_TEXTURE_SIZE)
//
//            if (check(2, 2) && version.profile == Profile.COMPATIBILITY) {
//                MAX_VARYING_COMPONENTS = GL11.glGetInteger(GL30.GL_MAX_VARYING_COMPONENTS)
//                MAX_VARYING_VECTORS = GL11.glGetInteger(GL41.GL_MAX_VARYING_VECTORS)
//                MAX_VARYING_FLOATS = GL11.glGetInteger(GL20.GL_MAX_VARYING_FLOATS)
//            }
//
//            if (check(3, 2)) {
//                MAX_COMBINED_UNIFORM_BLOCKS = GL11.glGetInteger(GL31.GL_MAX_COMBINED_UNIFORM_BLOCKS)
...
//                UNIFORM_BUFFER_OFFSET_ALIGNMENT = GL11.glGetInteger(GL31.GL_UNIFORM_BUFFER_OFFSET_ALIGNMENT)
//            }
//
//            if (check(4, 0)) {
//                MAX_PATCH_VERTICES = GL11.glGetInteger(GL40.GL_MAX_PATCH_VERTICES)
//                MAX_TESS_GEN_LEVEL = GL11.glGetInteger(GL40.GL_MAX_TESS_GEN_LEVEL)
//                MAX_SUBROUTINES = GL11.glGetInteger(GL40.GL_MAX_SUBROUTINES)
//                MAX_SUBROUTINE_UNIFORM_LOCATIONS = GL11.glGetInteger(GL40.GL_MAX_SUBROUTINE_UNIFORM_LOCATIONS)
//                MAX_COMBINED_ATOMIC_COUNTERS = GL11.glGetInteger(GL42.GL_MAX_COMBINED_ATOMIC_COUNTERS)
//                MAX_COMBINED_SHADER_STORAGE_BLOCKS = GL11.glGetInteger(GL43.GL_MAX_COMBINED_SHADER_STORAGE_BLOCKS)
//                MAX_PROGRAM_TEXEL_OFFSET = GL11.glGetInteger(GL30.GL_MAX_PROGRAM_TEXEL_OFFSET)
//                MIN_PROGRAM_TEXEL_OFFSET = GL11.glGetInteger(GL30.GL_MIN_PROGRAM_TEXEL_OFFSET)
//            }
//
//            if (check(4, 1)) {
//                NUM_PROGRAM_BINARY_FORMATS = GL11.glGetInteger(GL41.GL_NUM_PROGRAM_BINARY_FORMATS)
//                NUM_SHADER_BINARY_FORMATS = GL11.glGetInteger(GL41.GL_NUM_SHADER_BINARY_FORMATS)
//                PROGRAM_BINARY_FORMATS = GL11.glGetInteger(GL41.GL_PROGRAM_BINARY_FORMATS)
//            }
//
//            if (check(4, 2)) {
//                MAX_COMBINED_SHADER_OUTPUT_RESOURCES = GL11.glGetInteger(GL43.GL_MAX_COMBINED_SHADER_OUTPUT_RESOURCES)
...
//                MAX_COMBINED_SHADER_OUTPUT_RESOURCES = GL11.glGetInteger(GL43.GL_MAX_COMBINED_SHADER_OUTPUT_RESOURCES)
//                SHADER_STORAGE_BUFFER_OFFSET_ALIGNMENT = GL11.glGetInteger(GL43.GL_SHADER_STORAGE_BUFFER_OFFSET_ALIGNMENT)
//            }
//
//            if (check(4, 3))
//                MAX_COMBINED_SHADER_OUTPUT_RESOURCES = GL11.glGetInteger(GL43.GL_MAX_COMBINED_SHADER_OUTPUT_RESOURCES)
...
//                MAX_UNIFORM_LOCATIONS = GL11.glGetInteger(GL43.GL_MAX_UNIFORM_LOCATIONS)
//        }
//
//        fun write(w: PrintWriter) = this::class.memberProperties.filter { it.visibility == KVisibility.PUBLIC }.map {
//            w.println("${it.name} = ${it.getter.call(this)}")
...
//        @JvmField
//        val PRIMITIVE_RESTART_FOR_PATCHES_SUPPORTED = GL11.glGetBoolean(GL44.GL_PRIMITIVE_RESTART_FOR_PATCHES_SUPPORTED)
//
//        @JvmField
...
//        @JvmField
//        val MAX_RENDERBUFFER_SIZE = GL11.glGetInteger(GL30.GL_MAX_RENDERBUFFER_SIZE)
//
//        @JvmField
...
//        @JvmField
//        val POINT_SIZE_RANGE = glGetVec2(GL11.GL_POINT_SIZE_RANGE)
//        @JvmField
//        val POINT_SIZE_GRANULARITY = GL11.glGetFloat(GL11.GL_POINT_SIZE_GRANULARITY)
//
//        @JvmField
//        val ALIASED_LINE_WIDTH_RANGE = glGetVec2(GL12.GL_ALIASED_LINE_WIDTH_RANGE)
//        @JvmField
//        val SMOOTH_LINE_WIDTH_RANGE = glGetVec2(GL12.GL_SMOOTH_LINE_WIDTH_RANGE)
//        @JvmField
//        val SMOOTH_LINE_WIDTH_GRANULARITY = GL11.glGetFloat(GL12.GL_SMOOTH_LINE_WIDTH_GRANULARITY)
//
//        @JvmField
...
//
//            if (check(2, 1)) {
//                MAX_ELEMENTS_INDICES = GL11.glGetInteger(GL12.GL_MAX_ELEMENTS_INDICES)
//                MAX_ELEMENTS_VERTICES = GL11.glGetInteger(GL12.GL_MAX_ELEMENTS_VERTICES)
//            }
//
//            if (check(4, 3) || extensions.ARB_vertex_attrib_binding) {
//                MAX_VERTEX_ATTRIB_RELATIVE_OFFSET = GL11.glGetInteger(GL43.GL_MAX_VERTEX_ATTRIB_RELATIVE_OFFSET)
//                MAX_VERTEX_ATTRIB_BINDINGS = GL11.glGetInteger(GL43.GL_MAX_VERTEX_ATTRIB_BINDINGS)
//            }
//
//            if (check(4, 3) || extensions.ARB_ES3_compatibility)
//                MAX_ELEMENT_INDEX = GL32.glGetInteger64(GL43.GL_MAX_ELEMENT_INDEX)
//
//            if (version.profile == Profile.COMPATIBILITY) {
//                POINT_SIZE_MIN = GL11.glGetFloat(GL14.GL_POINT_SIZE_MIN)
//                POINT_SIZE_MAX = GL11.glGetFloat(GL14.GL_POINT_SIZE_MAX)
//            }
//
//
//            if (check(2, 1)) {
//                SUBPIXEL_BITS = GL11.glGetInteger(GL11.GL_SUBPIXEL_BITS)
//                MAX_VIEWPORT_DIMS = GL11.glGetFloat(GL11.GL_MAX_VIEWPORT_DIMS)
//            }
//
//            if (check(3, 0)) {
//                MAX_CLIP_DISTANCES = GL11.glGetInteger(GL30.GL_MAX_CLIP_DISTANCES)
//            }
//
//            if (check(4, 5) || extensions.ARB_cull_distance) {
//                MAX_CULL_DISTANCES = GL11.glGetInteger(GL45.GL_MAX_CULL_DISTANCES)
//                MAX_COMBINED_CLIP_AND_CULL_DISTANCES = GL11.glGetInteger(GL45.GL_MAX_COMBINED_CLIP_AND_CULL_DISTANCES)
//            }
//
//            if (check(4, 1) || extensions.ARB_viewport_array) {
//                MAX_VIEWPORTS = GL11.glGetInteger(GL41.GL_MAX_VIEWPORTS)
//                VIEWPORT_SUBPIXEL_BITS = GL11.glGetInteger(GL41.GL_VIEWPORT_SUBPIXEL_BITS)
//                VIEWPORT_BOUNDS_RANGE = glGetVec2(GL41.GL_VIEWPORT_BOUNDS_RANGE)
//                LAYER_PROVOKING_VERTEX = GL11.glGetInteger(GL41.GL_LAYER_PROVOKING_VERTEX)
//                VIEWPORT_INDEX_PROVOKING_VERTEX = GL11.glGetInteger(GL41.GL_VIEWPORT_INDEX_PROVOKING_VERTEX)
//            }
//
//            if (check(4, 1) || extensions.ARB_ES2_compatibility) {
//                IMPLEMENTATION_COLOR_READ_FORMAT = GL11.glGetInteger(GL41.GL_IMPLEMENTATION_COLOR_READ_FORMAT)
//                IMPLEMENTATION_COLOR_READ_TYPE = GL11.glGetInteger(GL41.GL_IMPLEMENTATION_COLOR_READ_TYPE)
//            }
//
//            if (check(2, 1)) {
//                MAX_TEXTURE_LOD_BIAS = GL11.glGetInteger(GL14.GL_MAX_TEXTURE_LOD_BIAS)
//                MAX_TEXTURE_SIZE = GL11.glGetInteger(GL11.GL_MAX_TEXTURE_SIZE)
//                MAX_3D_TEXTURE_SIZE = GL11.glGetInteger(GL12.GL_MAX_3D_TEXTURE_SIZE)
//                MAX_CUBE_MAP_TEXTURE_SIZE = GL11.glGetInteger(GL13.GL_MAX_CUBE_MAP_TEXTURE_SIZE)
//            }
//
...
//                TEXTURE_BUFFER_OFFSET_ALIGNMENT = GL11.glGetInteger(GL43.GL_TEXTURE_BUFFER_OFFSET_ALIGNMENT)
//        }
//
...
//            GL11.glGetIntegerv(GL13.GL_COMPRESSED_TEXTURE_FORMATS, buffer)
...
//
//        @JvmField
//        val COMPRESSED_RGB_S3TC_DXT1_EXT = has(EXTTextureCompressionS3TC.GL_COMPRESSED_RGB_S3TC_DXT1_EXT)
//        @JvmField
//        val COMPRESSED_RGBA_S3TC_DXT1_EXT = has(EXTTextureCompressionS3TC.GL_COMPRESSED_RGBA_S3TC_DXT1_EXT)
//        @JvmField
//        val COMPRESSED_RGBA_S3TC_DXT3_EXT = has(EXTTextureCompressionS3TC.GL_COMPRESSED_RGBA_S3TC_DXT3_EXT)
//        @JvmField
//        val COMPRESSED_RGBA_S3TC_DXT5_EXT = has(EXTTextureCompressionS3TC.GL_COMPRESSED_RGBA_S3TC_DXT5_EXT)
//        @JvmField
//        val COMPRESSED_SRGB_S3TC_DXT1_EXT = has(EXTTextureSRGB.GL_COMPRESSED_SRGB_S3TC_DXT1_EXT)
//        @JvmField
//        val COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT = has(EXTTextureSRGB.GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT)
//        @JvmField
//        val COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT = has(EXTTextureSRGB.GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT)
//        @JvmField
//        val COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT = has(EXTTextureSRGB.GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT)
//
//        @JvmField
//        val COMPRESSED_RED_RGTC1 = has(GL30.GL_COMPRESSED_RED_RGTC1)
//        @JvmField
//        val COMPRESSED_SIGNED_RED_RGTC1 = has(GL30.GL_COMPRESSED_SIGNED_RED_RGTC1)
//        @JvmField
//        val COMPRESSED_RG_RGTC2 = has(GL30.GL_COMPRESSED_RG_RGTC2)
//        @JvmField
//        val COMPRESSED_SIGNED_RG_RGTC2 = has(GL30.GL_COMPRESSED_SIGNED_RG_RGTC2)
//        @JvmField
//        val COMPRESSED_RGBA_BPTC_UNORM = has(GL42.GL_COMPRESSED_RGBA_BPTC_UNORM)
//        @JvmField
//        val COMPRESSED_SRGB_ALPHA_BPTC_UNORM = has(GL42.GL_COMPRESSED_SRGB_ALPHA_BPTC_UNORM)
//        @JvmField
//        val COMPRESSED_RGB_BPTC_SIGNED_FLOAT = has(GL42.GL_COMPRESSED_RGB_BPTC_SIGNED_FLOAT)
//        @JvmField
//        val COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT = has(GL42.GL_COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT)
//        @JvmField
//        val COMPRESSED_R11_EAC = has(GL43.GL_COMPRESSED_R11_EAC)
//        @JvmField
//        val COMPRESSED_SIGNED_R11_EAC = has(GL43.GL_COMPRESSED_SIGNED_R11_EAC)
//        @JvmField
//        val COMPRESSED_RG11_EAC = has(GL43.GL_COMPRESSED_RG11_EAC)
//        @JvmField
//        val COMPRESSED_SIGNED_RG11_EAC = has(GL43.GL_COMPRESSED_SIGNED_RG11_EAC)
//        @JvmField
//        val COMPRESSED_RGB8_ETC2 = has(GL43.GL_COMPRESSED_RGB8_ETC2)
//        @JvmField
//        val COMPRESSED_SRGB8_ETC2 = has(GL43.GL_COMPRESSED_SRGB8_ETC2)
//        @JvmField
//        val COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2 = has(GL43.GL_COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2)
//        @JvmField
//        val COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2 = has(GL43.GL_COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2)
//        @JvmField
//        val COMPRESSED_RGBA8_ETC2_EAC = has(GL43.GL_COMPRESSED_RGBA8_ETC2_EAC)
//        @JvmField
//        val COMPRESSED_SRGB8_ALPHA8_ETC2_EAC = has(GL43.GL_COMPRESSED_SRGB8_ALPHA8_ETC2_EAC)
//
//        @JvmField
//        val COMPRESSED_RGBA_ASTC_4x4_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_RGBA_ASTC_4x4_KHR)
//        @JvmField
//        val COMPRESSED_RGBA_ASTC_5x4_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_RGBA_ASTC_5x4_KHR)
//        @JvmField
//        val COMPRESSED_RGBA_ASTC_5x5_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_RGBA_ASTC_5x5_KHR)
//        @JvmField
//        val COMPRESSED_RGBA_ASTC_6x5_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_RGBA_ASTC_6x5_KHR)
//        @JvmField
//        val COMPRESSED_RGBA_ASTC_6x6_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_RGBA_ASTC_6x6_KHR)
//        @JvmField
//        val COMPRESSED_RGBA_ASTC_8x5_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_RGBA_ASTC_8x5_KHR)
//        @JvmField
//        val COMPRESSED_RGBA_ASTC_8x6_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_RGBA_ASTC_8x6_KHR)
//        @JvmField
//        val COMPRESSED_RGBA_ASTC_8x8_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_RGBA_ASTC_8x8_KHR)
//        @JvmField
//        val COMPRESSED_RGBA_ASTC_10x5_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_RGBA_ASTC_10x5_KHR)
//        @JvmField
//        val COMPRESSED_RGBA_ASTC_10x6_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_RGBA_ASTC_10x6_KHR)
//        @JvmField
//        val COMPRESSED_RGBA_ASTC_10x8_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_RGBA_ASTC_10x8_KHR)
//        @JvmField
//        val COMPRESSED_RGBA_ASTC_10x10_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_RGBA_ASTC_10x10_KHR)
//        @JvmField
//        val COMPRESSED_RGBA_ASTC_12x10_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_RGBA_ASTC_12x10_KHR)
//        @JvmField
//        val COMPRESSED_RGBA_ASTC_12x12_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_RGBA_ASTC_12x12_KHR)
//        @JvmField
//        val COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR)
//        @JvmField
//        val COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR)
//        @JvmField
//        val COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR)
//        @JvmField
//        val COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR)
//        @JvmField
//        val COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR)
//        @JvmField
//        val COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR)
//        @JvmField
//        val COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR)
//        @JvmField
//        val COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR)
//        @JvmField
//        val COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR)
//        @JvmField
//        val COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR)
//        @JvmField
//        val COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR)
//        @JvmField
//        val COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR)
//        @JvmField
//        val COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR)
//        @JvmField
//        val COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR = has(KHRTextureCompressionASTCLDR.GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR)
//
//        @JvmField
//        val COMPRESSED_LUMINANCE_LATC1_EXT = has(EXTTextureCompressionLATC.GL_COMPRESSED_LUMINANCE_LATC1_EXT)
//        @JvmField
//        val COMPRESSED_SIGNED_LUMINANCE_LATC1_EXT = has(EXTTextureCompressionLATC.GL_COMPRESSED_SIGNED_LUMINANCE_LATC1_EXT)
//        @JvmField
//        val COMPRESSED_LUMINANCE_ALPHA_LATC2_EXT = has(EXTTextureCompressionLATC.GL_COMPRESSED_LUMINANCE_ALPHA_LATC2_EXT)
//        @JvmField
//        val COMPRESSED_SIGNED_LUMINANCE_ALPHA_LATC2_EXT = has(EXTTextureCompressionLATC.GL_COMPRESSED_SIGNED_LUMINANCE_ALPHA_LATC2_EXT)
//        @JvmField
//        val COMPRESSED_LUMINANCE_ALPHA_3DC_ATI = has(ATITextureCompression3DC.GL_COMPRESSED_LUMINANCE_ALPHA_3DC_ATI)
//
//        @JvmField
...
//        @JvmField
//        val ETC1_RGB8_OES = has(GLES1.GL_ETC1_RGB8_OES)
//
